...
$('show-single').onclick=()=>{history.replaceState(null,'',location.pathname+'#single');setView(true);};$('show-skid').onclick=()=>{history.replaceState(null,'',location.pathname);setView(false);};
